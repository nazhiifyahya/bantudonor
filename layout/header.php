...
<header>
    <div class="w-full px-6 sm:px-20 py-4 border-b border-slate-200 flex justify-between items-center max-w-[1280px] relative mx-auto">
        ...
        <nav class="hidden md:flex justify-start items-center gap-5">
            <a href="<?php echo $baseUrl; ?>/index.php" class="<?php echo $currentPage === 'home' ? 'text-red-500 font-semibold' : 'text-slate-600'; ?> text-base hover:text-red-500 transition-colors">Home</a>
            ...
            <?php else: ?>
                <!-- Guest user menu -->
                <a href="<?php echo $baseUrl; ?>/register.php" class="<?php echo $currentPage === 'register' ? 'text-red-500 font-semibold' : 'text-slate-600'; ?> text-base hover:text-red-500 transition-colors">Jadi Relawan</a>
                <a href="<?php echo $baseUrl; ?>/login.php" class="px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors">Login</a>
            <?php endif; ?>
        </nav>
    ...
    <nav id="mobile-menu" class="hidden md:hidden px-6 pb-4 max-w-[1280px] mx-auto bg-white border-b border-slate-200">
        ...
        <?php else: ?>
            <a href="<?php echo $baseUrl; ?>/register.php" class="block py-2 text-base hover:text-red-500 <?php echo $currentPage === 'register' ? 'text-red-500 font-semibold' : 'text-slate-600'; ?>">Jadi Relawan</a>
            <a href="<?php echo $baseUrl; ?>/login.php" class="block py-2 px-4 mt-2 bg-red-500 text-white rounded-lg text-center hover:bg-red-600 transition-colors">Login</a>
        <?php endif; ?>
    </nav>
</header>
