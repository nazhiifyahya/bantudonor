    ...
    <div class="w-full px-6 sm:px-10 md:px-20 py-16 flex flex-col md:flex-row justify-between items-center max-w-[1280px] relative mx-auto">
        <div class="w-full md:w-[486px] flex flex-col justify-start items-start gap-4 mb-8 md:mb-0">
            ...
            <div class="flex flex-col sm:flex-row justify-start items-start sm:items-center gap-4 mt-4">
                <a href="create_request" class="px-8 py-3 bg-red-500 rounded-full text-slate-50 text-base font-semibold text-center w-full sm:w-auto">Ajukan Permohonan</a>
                <?php if (!isset($_SESSION['user_id'])): ?>
                    <a href="register" class="px-8 py-3 bg-red-500 rounded-full text-slate-50 text-base font-semibold text-center w-full sm:w-auto">Jadi Relawan</a>
                <?php else: ?>
                    <a href="blood_requests" class="px-8 py-3 bg-red-500 rounded-full text-slate-50 text-base font-semibold text-center w-full sm:w-auto">Jadi Relawan</a>
                <?php endif; ?>
            </div>
        </div>
...
<section class="bg-red-500">
    <div class="w-full px-6 sm:px-10 md:px-20 py-16 flex flex-col justify-center items-start gap-10 max-w-[1280px] relative mx-auto">
        <div class="w-full flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-0">
            ...
            <a href="blood_requests" class="px-8 py-3 rounded-full border border-slate-50 text-slate-50 text-base font-semibold text-center">Lihat Semua</a>
        </div>
